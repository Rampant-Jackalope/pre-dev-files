...
### bbcode references
- [bbcode quick reference](https://www.roleplayerguild.com/bbcode)
- [special godot bbcode](https://docs.godotengine.org/en/stable/tutorials/ui/bbcode_in_richtextlabel.html#shake)
